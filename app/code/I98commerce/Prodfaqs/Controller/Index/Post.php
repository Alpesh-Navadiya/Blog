    ...
    public function execute()
    {
        ...
        if ($error == false) {
            ...
            try {
                ...
                $newData = ['title' => $question, 'status' => $status, 'faqs_topic_id' => $topic_id, 'question_by'=> $customer_name, 'user_email'=> $customer_email, 'pro_id'=> $product_id, 'product_id'=> $product_id ,'show_on_main' => $isprivate ,'user_id'=>$custid,'product_name'=>$productname , 'product_url'=> $producturl];
