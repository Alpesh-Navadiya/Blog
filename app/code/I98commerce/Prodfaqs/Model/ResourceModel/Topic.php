...
class Topic extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('i98commerce_faqs_topic', 'faqs_topic_id');
    }
    ...
    protected function _beforeDelete(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $this->getConnection()->delete($this->getTable('i98commerce_faqs_topic_store'), $condition);
    ...
    protected function _afterSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $table = $this->getTable('i98commerce_faqs_topic_store');
    ...
    public function lookupStoreIds($faqTopicId)
    {
        ...
        $select = $connection->select()->from(
            $this->getTable('i98commerce_faqs_topic_store'),
            'store_id'
        )->where(
            'faqs_topic_id = ?',
            (int)$faqTopicId
    ...
    public function getIsUniqueTopicToStores(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        $select = $this->getConnection()->select()->from(
            ...
            ['fts' => $this->getTable('i98commerce_faqs_topic_store')],
